...
print_symbol, instance tracking, a static method to compare
rectangles by area, and a class method to create squares.
"""
...
class Rectangle:
    ...
    def square(cls, size=0):
        ...
        Args:
            size (int): The size of the new square's sides.
